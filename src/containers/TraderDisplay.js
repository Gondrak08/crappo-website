        ...
        <div className="trader-container relative h-[1490px] flex flex-col items-center  ">
            ...
            <div className="container relative top-[10em]  flex flex-col items-center justify-center">
                <div className="texts my-10  flex flex-col justify-center gap-3 w-[fit-content] ">
                    <h2 className="text-[40px] font-[700] text-center text-crawhite">Check how much you can earn</h2>
                ...
                <div className="calculate-box  p-8 rounded-xl w-full max-w-[942px] h-[100%] max-h-[371px]  flex flex-col gap-5 bg-[#FBFCFE]">
                    <div className="inputbox  flex justify-between items-center gap-5">
                        <input type="text" className="w-[45%] border-[none] border-b-[1px] border-cragreyneutral h-[38px] " placeholder="Enter your hash rate" />

                        <select name="" id="" className="border-[none] border-b-[1px] w-[25%] border-cragreyneutral h-[38px]">
                    ...
                    <div className="texts flex mt-7 flex-col gap-1 ">
                        ...
                        <h3 className="text-[32px] font-[700] tracking-[.04em]" >
            ...
            <div className="crypto-container  h-full w-full flex justify-center ">
                <div className="container mt-20 flex flex-col gap-10 items-center justify-center  ">
                    <h3 className="text-[40px] text-center font-[700] text-cradark " >Trade securely and market the high <br/>growth cryptocurrencies.
                    </h3>
                    <div className="cards grid w-full grid-cols-3 gap-5">
                        {
                            cards.map((item, index) => (
                                <div className="card flex flex-col  items-center justify-evenly gap-5 py-4 px-2  rounded-xl  h-[400px] bg-[#FFFFFF]  " key={index}>
                                    <div className="image">
